...
async def overview(request: Request):
    ...
    return templates.TemplateResponse("overview.html", {
        ...
        "distribution_plot": dist_plot.to_html(full_html=False, include_plotlyjs='cdn')
    })
...
async def elbow_method_page(request: Request):
    ...
    return templates.TemplateResponse("elbow.html", {
        "request": request,
...
async def clustering_results(request: Request):
    ...
    plot_pca = create_pca_plot(
        ...
        analysis_results['clustering']['labels']
    )
    
    return templates.TemplateResponse("clustering.html", {
        "request": request,
        "title": "Clustering Results",
        "plot_2d_1": plot_2d_income_spending.to_html(full_html=False, include_plotlyjs='cdn'),
        "plot_2d_2": plot_2d_income_age.to_html(full_html=False, include_plotlyjs='cdn'),
...
async def quality_metrics(request: Request):
    ...
    return templates.TemplateResponse("quality.html", {
        ...
        "silhouette_plot": silhouette_plot.to_html(full_html=False, include_plotlyjs='cdn'),
        "characteristics_plot": characteristics_plot.to_html(full_html=False, include_plotlyjs='cdn'),
        "statistical_plot": statistical_plot.to_html(full_html=False, include_plotlyjs='cdn'),
        "stability_plot": stability_plot.to_html(full_html=False, include_plotlyjs='cdn')
    })
...
async def efficiency_analysis(request: Request):
    ...
    return templates.TemplateResponse("efficiency.html", {
        ...
        "efficiency_plot": efficiency_plot.to_html(full_html=False, include_plotlyjs='cdn'),
...
async def business_insights(request: Request):
    ...
    return templates.TemplateResponse("business.html", {
        ...
        "business_plot": business_plot.to_html(full_html=False, include_plotlyjs='cdn'),
        "profiles_table": profiles_table.to_html(full_html=False, include_plotlyjs='cdn'),
